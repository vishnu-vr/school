...
namespace school
{
    public class XMLManageStaff : IManageStaff
    {
        readonly XMLStorageManager storageManager;

        public XMLManageStaff()
        {
            this.storageManager = new XMLStorageManager();
        }
        ...
        public bool Update(int empCode, string name, string email, string extra)
        {
            ...
            try
            {
                ...
                if (staff.Type == StaffType.support)
                {
